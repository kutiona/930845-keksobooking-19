...
var OFFER_FEUTURES = [
  ...
  ['wifi', 'parking', 'washer', 'conditioner']
];
...
var generateAds = function (quantity) {
  ...
  for (var i = 0; i < quantity; i++) {
    var location_x = getRandomInteger(START_LOCATION_X, END_LOCATION_X);
    var location_y = getRandomInteger(START_LOCATION_Y, END_LOCATION_Y);
